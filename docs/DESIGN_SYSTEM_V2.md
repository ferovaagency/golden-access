...
- [ ] Fase 7 — 3D + optimización (escena WebGL del hero con three/@react-three/fiber/@react-three/drei — pendiente, requiere nuevas dependencias, el manual pide rama separada).
